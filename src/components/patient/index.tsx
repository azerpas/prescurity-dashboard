...
import {Avatar, Button, Center, Container, Text, useClipboard} from "@chakra-ui/react";
                        ...
                        <>
                            <Container>
                                ...
                                <Flex direction="column" align="center" margin={{base: "auto", md: "1rem"}}>
                                    <Text mt="5rem">Your security social number :</Text>
                                    <Flex m={"auto"} textAlign={"center"} alignContent={"baseline"} my={"2rem"}>
                                        <Input isReadOnly alignSelf={"center"} value={context.user.uid}/>
                                        <Button maxW={"min-content"} alignSelf={"center"} ml={"0.5rem"} onClick={onCopy}> {hasCopied ? "Copied" : "Copy"} </Button>
                                    </Flex>
                                    <Container mt="5rem">
                                        <Center>
